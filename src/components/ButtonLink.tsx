...
export default function ButtonLink({children, to, hasActiveClassName = false}: Props) {

  return (
    <NavLink
      to={to}
      className="text-white font-normal border border-white px-4 py-2 rounded 
        hover:bg-netflix hover:border-netflix transition-colors duration-200 ease-out"
